    ...
    <section id="services" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-8 relative z-10">
        ...
        <div className="mt-20 text-center">
           <a href="https://api.whatsapp.com/send?phone=1234567890" className="inline-flex items-center gap-4 px-10 py-5 bg-emerald-600 rounded-full font-bold hover:bg-emerald-500 hover:scale-105 transition-all duration-300">
